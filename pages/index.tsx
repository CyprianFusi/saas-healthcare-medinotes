              ...
              <div className="max-w-6xl mx-auto px-6 py-8">
                  <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                      <div className="flex items-center space-x-2">
                          ...
                          <span className="text-gray-600 font-medium">Healthcare Consultation Assistant</span>
                          <span className="text-sm text-gray-500 text-center">&#169; Binati AInalytics, {new Date().getFullYear()}</span>
                      </div>
                      <div className="text-sm text-gray-500 text-center md:text-right">
                          <p>Powered by OpenAI & Next.js</p>
                          <p className="text-xs mt-1">Transforming healthcare into AI Agent Economy</p>
                      </div>
                  </div>
              </div>
        </footer>
